...
router.put(
  "/:billId/shipping",
  Authorize([Permission.BillManagement, Permission.UpdateShippingBillStatus]),
  billController.updateShippingStatus
);
router.put(
  "/:billId/complete",
  Authorize([Permission.BillManagement, Permission.UpdateCompleteBillStatus]),
  billController.updateCompleteStatus
);
router.get(
  "/",
  Authorize([
...
router.post(
  "/:billId/dishes/:dishId",
  Authorize(Permission.BillManagement),
  billController.addDish
);
router.delete(
  "/:billId/dishes/:dishId",
  Authorize(Permission.BillManagement),
  billController.removeDish
);
