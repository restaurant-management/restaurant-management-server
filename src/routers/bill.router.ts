...
router.put('/:billId/created', Authorize([Permission.BillManagement, Permission.UpdatePaidBillStatus]), billController.updateCreatedStatus);
router.put('/:billId/paid', Authorize([Permission.BillManagement, Permission.UpdatePaidBillStatus]), billController.updatePaidStatus);
router.put('/:billId/delivering', Authorize([Permission.BillManagement, Permission.UpdateDeliveringBillStatus]), billController.updateDeliveringStatus);
router.put('/:billId/preparing', Authorize([Permission.BillManagement, Permission.UpdatePreparingBillStatus]), billController.updatePreparingStatus);
router.put('/:billId/prepare-done', Authorize([Permission.BillManagement, Permission.UpdatePrepareDoneBillStatus]), billController.updatePrepareDoneStatus);
router.put('/:billId/shipping', Authorize([Permission.BillManagement, Permission.UpdateShippingBillStatus]), billController.updateShippingStatus);
